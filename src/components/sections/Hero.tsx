...
export function Hero() {
  return (
    <section className="relative min-h-[92vh] overflow-hidden bg-navy-950 pt-16 md:pt-20">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-navy-950 to-transparent" />
      ...
      <Container className="relative z-10 grid min-h-[82vh] items-center gap-12 py-16 lg:grid-cols-[1.2fr_1fr] lg:gap-16 lg:py-20">
        <div>
          ...
          <motion.h1
            ...
            className="mt-5 text-balance text-5xl font-bold leading-[1.05] tracking-tight text-white md:text-6xl lg:text-hero"
          >
            AI That Actually{" "}
            <span className="bg-gradient-to-br from-teal-300 via-teal-400 to-blue-400 bg-clip-text text-transparent">
              Collects Revenue
            </span>
          </motion.h1>
          <motion.p
            ...
            className="mt-6 max-w-xl text-body text-gray-400"
          >
            {SITE.description}
          </motion.p>
          <motion.div
          ...
          <motion.div
            ...
            className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-2 text-caption text-gray-400"
          >
        ...
        <div className="lg:hidden">
          <div className="relative overflow-hidden rounded-xl border border-white/10 bg-navy-900/70 p-5">
            <DashboardVisual />
          </div>
        </div>
      </Container>
